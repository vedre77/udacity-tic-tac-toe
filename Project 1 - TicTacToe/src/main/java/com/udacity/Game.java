...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        ArrayList<Integer> oRows = new ArrayList<>();
        ArrayList<Integer> oCols = new ArrayList<>();
        ArrayList<Character> firstDiagonal = new ArrayList<>();
        ArrayList<Character> secondDiagonal = new ArrayList<>();
        int freeTileCount = 0;
        ...
        int firstDiagXReps = Collections.frequency(firstDiagonal, 'x');
        int secondDiagXReps = Collections.frequency(secondDiagonal, 'x');
        int firstDiagOReps = Collections.frequency(firstDiagonal, 'o');
        int secondDiagOReps = Collections.frequency(secondDiagonal, 'o');
        for (int i = 0; i < grid.length; i++) {
            int xColReps = Collections.frequency(xCols, i);
            int xRowReps = Collections.frequency(xRows, i);
            int oColReps = Collections.frequency(oCols, i);
            int oRowReps = Collections.frequency(oRows, i);
            if (xColReps == 3 || xRowReps == 3 || firstDiagXReps == 3 || secondDiagXReps == 3) {
                result = "X is the winner!";
                return result;
            }
            if (oColReps == 3 || oRowReps == 3 || firstDiagOReps == 3 || secondDiagOReps == 3) {
        ...
        System.out.println(freeTileCount);
        return result;
    }
